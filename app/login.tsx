   ...
   >
     ...
     <SafeAreaView style={styles.safe}>
       <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.inner}>
         ...
         {modo === 'registro' && (
           <View style={styles.form}>
             <TextInput style={styles.input} placeholder="Nombre(s)" placeholderTextColor="rgba(255,255,255,0.4)" value={nombre} onChangeText={setNombre} autoCapitalize="words" />
             <TextInput style={styles.input} placeholder="Apellidos" placeholderTextColor="rgba(255,255,255,0.4)" value={apellido} onChangeText={setApellido} autoCapitalize="words" />
             ...
             <TextInput style={styles.input} placeholder="Correo electrónico" placeholderTextColor="rgba(255,255,255,0.4)" value={email} onChangeText={setEmail} keyboardType="email-address" autoCapitalize="none" />
             <TextInput style={styles.input} placeholder="Empresa (opcional)" placeholderTextColor="rgba(255,255,255,0.4)" value={empresa} onChangeText={setEmpresa} autoCapitalize="words" />
...
const styles = StyleSheet.create({
 ...
 obligatorio: { fontSize: 11, color: 'rgba(255,255,255,0.3)', textAlign: 'right', marginTop: -4 },
});
