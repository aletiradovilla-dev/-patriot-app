             ...
             <View key={vuelo.id} style={styles.card}>
               ...
               <View style={styles.infoGrid}>
                 <View style={styles.infoRow}>
                   ...
                   <Text style={styles.infoText}>{vuelo.fecha}</Text>
                 </View>
                 <View style={styles.infoRow}>
                   <Ionicons name="time-outline" size={12} color="rgba(255,255,255,0.35)" />
                   <Text style={styles.infoText}>{vuelo.hora}</Text>
                 </View>
                 <View style={styles.infoRow}>
                   <Ionicons name="airplane-outline" size={12} color="rgba(255,255,255,0.35)" />
                   <Text style={styles.infoText}>{vuelo.aeronave}</Text>
                 </View>
                 <View style={styles.infoRow}>
                   <Ionicons name="person-outline" size={12} color="rgba(255,255,255,0.35)" />
                   <Text style={styles.infoText}>{vuelo.asientos} disponibles</Text>
                 </View>
               </View>
...
const styles = StyleSheet.create({
 ...
 ruta: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 14 },
 ciudad: { fontSize: 20, color: '#fff', fontWeight: '500' },
 infoGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginBottom: 14 },
 infoRow: { flexDirection: 'row', alignItems: 'center', gap: 5, minWidth: '45%' },
